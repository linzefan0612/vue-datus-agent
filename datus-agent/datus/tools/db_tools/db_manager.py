...
except ImportError:  # pragma: no cover - downstream extension is optional.
...
class DBManager:
    ...
    def _build_conn(self, db_config: DbConfig) -> BaseSqlConnector:
        ...
        return apply_datasource_policy(conn, db_config)
    ...
    def _db_config_to_connection_config(self, db_config: DbConfig) -> Union[ConnectionConfig, dict]:
        ...
        if db_type == DBType.SQLITE:
            ...
            if db_config.extra:
                filtered_config.update(filter_adapter_extra_fields(db_config.extra))
